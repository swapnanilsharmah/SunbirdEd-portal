...
let envVariables = {
  ...
  LEARNER_URL: env.sunbird_learner_player_url || 'https://apgsws.in/api/',
  CONTENT_URL: env.sunbird_content_player_url || 'https://apgsws.in/api/',
  CONTENT_PROXY_URL: env.sunbird_content_proxy_url || 'https://apgsws.in',
  PORTAL_REALM: env.sunbird_portal_realm || 'sunbird',
  PORTAL_AUTH_SERVER_URL: env.sunbird_portal_auth_server_url || 'https://apgsws.in/auth',
  PORTAL_AUTH_SERVER_CLIENT: env.sunbird_portal_auth_server_client || 'portal',
  PORTAL_API_AUTH_TOKEN: env.sunbird_api_auth_token || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJqQXk2ME9rWlNxYVNMZmdIWkk5RGZ4WFdqV3pCTllaZiJ9.Z2Xlyfsem7pAUSQb21Pn92fRYcaKUriBSGBd_FmR6EY',
  PORTAL_ECHO_API_URL: env.sunbird_echo_api_url || 'https://apgsws.in/api/echo/',
  CONFIG_URL: env.sunbird_config_service_url || 'https://apgsws.in/api/config/',
  EKSTEP_ENV: env.ekstep_env || 'qa',
  DEVICE_REGISTER_API: process.env.sunbird_device_register_api || 'https://api.open-sunbird.org/v3/device/register/',
  DEVICE_PROFILE_API: process.env.sunbird_device_profile_api || 'https://apgsws.in/api/v3/device/profile/',
  ...
  REPORT_SERVICE_URL: env.sunbird_report_service_url || 'https://apgsws.in/api/data/v1/report-service',
  ...
  sunbird_azure_account_name: env.sunbird_azure_account_name || 'sunbirdstorage',
  sunbird_azure_account_key: env.sunbird_azure_account_key || 'F0jGeU7vyQ85wgnBQaGXOFYrpt3OTfdubLK5AsGKUVpaLTw0o9Ec3FJx0Rym83kmxP1KupstYvNcUx0d2brYCA==',
  desktop_azure_crash_container_name: env.desktop_crash_container_name || 'desktopappcrashlogs',
  sunbird_portal_cdn_blob_url: env.sunbird_portal_cdn_blob_url || 'https://sunbirdstorage.blob.core.windows.net/',
  ...
  DATASERVICE_URL: env.sunbird_dataservice_url || 'https://apgsws.in/api/',
